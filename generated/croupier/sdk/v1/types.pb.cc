...
const ::uint32_t TableStruct_croupier_2fsdk_2fv1_2ftypes_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
...
const ::_pbi::DescriptorTable descriptor_table_croupier_2fsdk_2fv1_2ftypes_2eproto = {
    ...
    file_level_metadata_croupier_2fsdk_2fv1_2ftypes_2eproto,
...
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_croupier_2fsdk_2fv1_2ftypes_2eproto(&descriptor_table_croupier_2fsdk_2fv1_2ftypes_2eproto);
namespace croupier {
namespace sdk {
namespace v1 {
